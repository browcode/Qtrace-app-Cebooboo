...
class TracerSignUp4 extends StatefulWidget {
  @override
  _TracerSignUp4State createState() => _TracerSignUp4State();
}

class _TracerSignUp4State extends State<TracerSignUp4> {
  bool _obscure = false;
            ...
            children: <Widget>[
              Container(
                ...
                child: SizedBox(
                  width: 348,
                  height: 163,
                  child: Image.asset('assets/images/Tracer4.png',
                      fit: BoxFit.contain),
                ),
              ),
              SizedBox(height: 38),
